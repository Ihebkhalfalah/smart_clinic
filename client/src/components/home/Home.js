...
const Home = ({ history, logged }) => {
  console.log(sessionStorage.getItem("loggedId"));
     ...
     useEffect(() => {
      Axios.get("http://localhost:3001/user/getAllMedecin", 
  ...
  return (
    <div>
      ...
      <div className="home-explore">
        <h3> OUR DOCTORS  {auth} {userId}</h3>
        <div className="home-doctors">
          {data.map((item, id) => (
            <Cards src="../img/doctors/doctor_2.jpg" des={item.des} key={id} title={item.username} room1="samer" room2="iheb"   />
          ))}
        </div>
      </div>
      {/*///////////////////////////////////////////////////////// Appointment section  */}
            ...
            <div className="row mt-5 ">
              ...
              <div className="col-12 col-sm-6 py-2 wow fadeInRight">
                <input
                  type="email"
                  className="form-control"
                  value="ihebkhalfallah23@gmail.com"
                  disabled
                />
              </div>
              <div
